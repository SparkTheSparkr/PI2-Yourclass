...
<head>
    ...
    <title>Detalhes do Curso - Fotografia Básica</title>
    ...
    <style>
        ...
        body{
            background-image: url("../../assets/images/fotografia/bgFotografia.jpg");
...
<body>
  ...
  <div class="container mt-5 custom-container">
    <div class="card">
      <img src="../../assets/images/index/fotoBasica.jpg" class="card-img-top" alt="Fotografia Básica">
      <div class="card-body">
        ...
        <div class="course-info">
          ...
          Durante o curso, você irá aprender desde o funcionamento da câmera até técnicas de composição e iluminação. 
          Conteúdo abordado no curso:</p>
          <ul>
            <li>Introdução aos tipos de câmeras e lentes</li>
            <li>Fundamentos da exposição: ISO, abertura e velocidade do obturador</li>
            <li>Composição e regra dos terços</li>
            <li>Uso criativo da luz natural e artificial</li>
            <li>Prática de fotografia de paisagem, retrato e macro</li>
            <li>Edição básica de imagens</li>
            <li>Introdução ao mercado de fotografia</li>
          </ul>
        </div>
        <div class="professor-info">
          <h3>Sobre o Professor</h3>
          <a href="../usuarios/professor.php" id="prof"><p><strong>Prof. Maria Souza</strong></p></a>
          <p>Maria Souza é uma renomada fotógrafa com experiência internacional e mais de 10 anos de carreira. 
          Formada em Fotografia pela Universidade de Artes de Londres, Maria já trabalhou em revistas renomadas e projetos fotográficos ao redor do mundo. 
          Ela é especializada em retratos e fotografia de eventos e possui uma abordagem didática única ao ensinar fotografia básica.</p>
        </div>
        <a href="comprarFoto.php" class="btn btn-primary mt-3">Comprar Curso</a>
      </div>
    </div>
